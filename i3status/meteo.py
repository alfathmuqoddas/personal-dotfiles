...
APPID = "4018b500122ee53a2b2b0ccc505a5ae4"
...
#     "cod": 200
# }
with urllib.request.urlopen("https://api.openweathermap.org/data/2.5/weather?q=" + CITYID + "&units=metric&appid=" + APPID) as url:
