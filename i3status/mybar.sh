...
# bar {
#   status_command exec /home/alfath2/.config/i3status/mybar.sh
# }
...
myip_public() {
  ...
  echo -n "\"full_text\":\" $(/home/alfath2/.config/i3status/ip.py) \","
...
disk_usage() {
  ...
  echo -n "\"full_text\":\"  $(/home/alfath2/.config/i3status/disk.py)%\","
  echo -n "\"background\":\"$bg\","
  common
  echo -n "}"
}
...
memory() {
  ...
  echo -n "\"full_text\":\"  $(/home/alfath2/.config/i3status/memory.py)%\","
...
cpu_usage() {
  ...
  echo -n "\"full_text\":\"  $(/home/alfath2/.config/i3status/cpu.sh)% \","
  echo -n "\"background\":\"#3949AB\","
  common
  echo -n "},"
}
...
meteo() {
  ...
  echo -n "\"full_text\":\" $(/home/alfath2/.config/i3status/meteo.py) \","
  echo -n "\"background\":\"$bg\","
  common
  echo -n "},"
}
...
readme() {
  ...
  separator $bg "#546E7A"
  echo -n ",{"
  echo -n "\"name\":\"id_readme\","
  echo -n "\"full_text\":\"  CLICK HERE!!! \","
  echo -n "\"color\":\"#FFFFFF\","
  echo -n "\"background\":\"$bg\","
  common
  echo -n "},"
...
do
  ...
  if [[ $line == *"name"*"id_vpn"* ]]; then
    lxterminal -e /home/you/.config/i3status/click_vpn.sh &
  ...
  # TIME
    ...
    lxterminal -e /home/alfath2/.config/i3status/click_time.sh &
  ...
  # README
  elif [[ $line == *"name"*"id_readme"* ]]; then
    viewnior /home/alfath2/Downloads/keybind-i3.png &
